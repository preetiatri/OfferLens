// Sample offers data for testing OfferLens categories
// This file contains sample offers for Groceries and Bill Pay & Recharges categories
// Copy this data to Firebase Firestore under the "offers" collection
...
// Instructions to add to Firebase:
// 1. Go to Firebase Console > Firestore Database
// 2. Navigate to the "offers" collection
// 3. Click "Add document" for each offer above
// 4. Use auto-generated ID or create custom IDs
// 5. Copy the fields from each offer object above

console.log(`Total sample offers: ${sampleOffers.length}`);
